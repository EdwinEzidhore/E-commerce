      ...
      return (
                        ...
                        <div className=' flex items-center  bg-white rounded-full py-1 px-2 input-container relative '>
                              ...
                              <div className='flex sm:justify-between  md:p-0 sm:p-2  ease-out md:text-[white]  uppercase tracking-wider font-light md:bg-transparent sm:bg-[#333333]'>
                                    ...
                                    <div className='flex  items-center     text-white'>
                                          ...
                                          {
                                                            isloggedin == true ?
                                                            <img className='h-8 border rounded-full' src={`http://localhost:3333/${user.avatar.url}`} alt="" />
            ...
            <div className={`fixed top-0 z-20 left-0 h-full pl-4 w-64 bg-[#333333] shadow-lg transform ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out`}>
                  <div className='flex flex-col p-5'>
                        ...
                        <div className='flex items-center space-x-2 text-xl text-white mb-3 mt-4'><AiFillHome /><a href="/" className='text-lg'>Home</a></div>
                        <div className='flex items-center text-white space-x-2 text-xl'><BiSolidCategory /><span className='text-lg'>Category</span></div>
                              <div className='px-7 pt-2 text-slate-400 '>
                                    <div className='mb-3'><a className='py-2' href="/men">Men</a></div>
                                    <div><a className='py-2' href="/women">Women</a></div>
                              </div>
                        ...
                        <div className='flex items-center mt-5 border-t-2 pt-3 border-gray-600 fixed bottom-5 left-3'>
                              ...
                              <div className='leading-3 ml-1'>
                                    <div className='text-sm font-poppins text-white'>Edwin Ezidhore</div>
