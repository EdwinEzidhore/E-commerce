...
const Nav = () => {
  ...
  useEffect(() => {
    axios
      .get(`${base_url}/api/v2/isLoggedIn`, { withCredentials: true })
      .then((res) => {
      ...
      .then((res) => {
        ...
        results = results?.filter((item) => {
          return (
            ...
            item.description.toLowerCase().includes(loweredInput)
          );
        });
  ...
  const handleLogOut = () => {
    axios
      .get(`${base_url}/api/v2/logout`, { withCredentials: true })
      .then((res) => {
  ...
  return (
    <>
      <nav className=" mx-auto z-50  lg:flex lg:sticky lg:top-0 lg:backdrop-blur-xl    flex-nowrap md:items-center py-4 md:px-2 xl:px-12  md:justify-evenly  font-poppins ">
        <div className=" h-fit lg:mb-0 mb-2 cursor-default">
          ...
          <div className="text-xs text-center">
            <span className="md:tracking-widest text-gray-500 font-extralight font-sans ">
              FASHION STORE
            </span>
          </div>
        </div>
        <div className="md:flex   lg:justify-center md:justify-between  items-center   md:bg-[#0d1b2a] lg:px-12 md:px-6  md:rounded-full py-2 ">
          <div className="md:flex lg:space-x-7 md:space-x-3 lg:gap-4 md:gap-3 items-center  tracking-wide">
            <div className="relative flex items-center  bg-white rounded-full py-1 px-2 input-container  ">
              <input
                autoComplete="off"
                className=" bg-[#e0e6ef]  md:w-72 sm:w-full  rounded-full md:py-1 md:px-4 px-5 py-2 outline-none expandable-input "
                type="search"
                placeholder="Search"
                name="search"
                id="search"
              ...
              <div>
                {searchInput.length > 0 && openSearchresults && (
                  <SearchResultsList
                    results={searchResults}
                    closeSearch={setOpenSearchresults}
                  />
                )}
              </div>
            </div>
            <div className="flex sm:justify-between  md:p-0 sm:p-2  ease-out md:text-[white]  uppercase tracking-wider font-light md:bg-transparent sm:bg-[#0d1b2a]">
              <div className=" lg:gap-4 md:space-x-6  md:gap-2 hidden md:block">
                <a className="hover:scale-110   text-sm " href="/">
                  Home
                </a>
                <a className="hover:scale-110  text-sm " href="/men">
                  Men
                </a>
                <a className="hover:scale-110  text-sm " href="/women">
                  Women
                </a>
              </div>
                ...
                <div className="relative px-4 py-2">
                  {cartLength > 0 && (
                    <button onClick={() => navigate("/cart")}>
                      <div className="   absolute  right-0 top-0 text-white  rounded-full w-6    text-center ">
                        <span className=" text-xs bg-red-500 py-1 px-2  font-bold  rounded-full">
                          {cartLength}
                        </span>
                      </div>
                    </button>
                  ...
                  <button>
                    <a className="" href="/cart">
                      <BiSolidShoppingBags className="text-xl text-white" />
                    </a>
                  </button>
                </div>
                <div>
              ...
              <div className="flex  items-center     text-white">
                ...
                <button
                  className="p-1 text-2xl ml-2 md:hidden"
                  onClick={toggleMenu}
                >
                  <TiThMenu />
                </button>
          ...
          <div className="md:flex lg:ml-12 space-x- md:items-center sm:hidden">
            <div className="relative px-4 py-2">
              ...
              <button>
                <a href="/cart">
                  <BiSolidShoppingBags className="text-white text-2xl" />
                </a>
              </button>
            </div>
            <div>
              <div className="px-4 py-2">
                <button className="">
                  <a href="/wishlist">
                    <GoHeartFill className="text-[#f86666] text-2xl" />
                  </a>
                </button>
              </div>
            </div>
      ...
      {/* Side Menu */}
      <div
        className={`md:hidden sm:block fixed top-0 z-20 left-0 h-full  pl-4 w-64 bg-[#0d1b2a] shadow-lg transform ${isMenuOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out`}
        aria-label="Sidebar"
      >
        <div className="flex flex-col p-5 h-full">
          <div className=" h-fit  mb-2 text-white border-b-2 pb-3 border-gray-600 cursor-default">
            <div className="text-center tracking-wider ">
              <span className="text-3xl font-serif font-semibold ">E</span>
              <span className="font-semibold text-3xl font-frank-lukh">
                ZIRE
              </span>
            </div>
            <div className="text-xs text-center">
              <span className="md:tracking-widest text-gray-400 font-extralight font-sans ">
                FASHION STORE
              </span>
            </div>
          </div>
          ...
          <div className="h-4/5 overflow-y-scroll">
            ...
            <div className="mx-1 mt-2 px-7 pt-2 text-slate-400 bg-[#] shadow-[black] rounded-md shadow-sm mb-3">
              <div className="mb-3">
                <a className="py-2" href="/men">
                  Men
                </a>
              </div>
              <div className="mb-3">
                <a className="py-2" href="/women">
                  Women
                </a>
              </div>
            </div>
            ...
            <div className=" text-white mb-1">
              <button
                className="flex items-center  white  text-xl mb-3"
                onClick={() => {
              ...
              >
                ...
                <div className="text-2xl ml-3">
                  {profieInfoOpen ? <MdArrowDropUp /> : <MdArrowDropDown />}
                </div>
              </button>
              {profieInfoOpen && (
                <div className="bg-[#]  shadow-[black] h-fit w-full text-base rounded-md shadow-inner">
                  <ul className="pl-4 py-2 text-slate-300">
                    <li className="mb-3">
                      <a href="/user-information">Profile Information</a>
                    </li>
                    <li className="mb-3">
            ...
            <div className=" text-white">
              ...
              >
                ...
                <div className="text-2xl ml-3">
                  {myStuffDropdown ? <MdArrowDropUp /> : <MdArrowDropDown />}
                </div>
              </button>
              {myStuffDropdown && (
                <div className="shadow-[black] h-fit w-full text-base rounded-md shadow-inner">
                  <ul className="pl-6 py-2 text-slate-300">
                    <li className="mb-3">
                      <a href="/coupon">My Coupons</a>
                    </li>
                    <li className="mb-3">
                      <a href="/wishlist">My Whishlist</a>
                    </li>
                  </ul>
                </div>
              )}
          ...
          {user ? (
            <div className="flex flex-col items-center mt-5  border-gray-600 fixed bottom-5 left-3">
              <div className="my-5">
                <button
                  className="h-auto flex items-center text-white font-semibold"
              ...
              <div className="flex border-t-2 pt-3">
                ...
                <div className="leading-3 ml-1">
                  <div>
                    <a href="/user-information" className="text-sm text-white">
                      {user ? user.name : ""}
                    </a>
                  </div>
