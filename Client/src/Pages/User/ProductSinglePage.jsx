      ...
      <section >
          ...
          <div className='container bg-red-30 bg-slate-100 font-poppins'>
              <div className='grid grid-cols-12 '>
                  <div className='grid col-span-4 p-1 border shadow-xl h-fit bg-white sticky top-0'>
                      <div className=''>
                          {/* <div className='absolute right-3 top-2 border flex p-2 rounded-full'><box-icon name='heart' ></box-icon></div> */}
                          <img src="/src/images/U-S-Polo-Assn-Men-s-Big-Logo-Polo-Shirt_a156b15e-67c0-48ee-9aae-9d4170f0ac95.e2ed6feec01251484cb6b04c9fac19d9.jpeg" alt="" className='max-h-96 w-full object-cover' /></div>

                      <div className='flex mt-5 gap-3 overflow-scroll'>
                          <div className='border p-1 flex-none'>
                          <img src="/src/images/U-S-Polo-Assn-Men-s-Big-Logo-Polo-Shirt_a156b15e-67c0-48ee-9aae-9d4170f0ac95.e2ed6feec01251484cb6b04c9fac19d9.jpeg" alt="" className='h-16   object-cover w-20' />
                          </div>
                  ...
                  <div className=' col-span-8 ml-3 bg-white border shadow-lg pl-3'>
                      <div className='mt-4'><span className='text-[#9a9494] font-semibold'>Brand</span></div>
                      
                      <div className='text-xl py-2'><span>Men Solid Polo Neck Pure Cotton White T-Shirt</span></div>
                      ...
                      <div className='flex items-center space-x-5 pt-2'>
                          ...
                          <span className='line-through text-slate-400'>₹1544</span>
